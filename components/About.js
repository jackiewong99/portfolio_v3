  ...
  return (
    <div className="flex min-h-screen min-w-full flex-col items-center px-8 py-12">
      <div className="flex justify-center pb-16">
        <h1 className="text-forest-700 text-4xl font-bold sm:text-5xl md:text-6xl xl:text-8xl">
          About Me
        </h1>
      </div>
      {/* ABOUT CONTENT */}
      <div className="flex w-4/5 items-center justify-around gap-6 px-16">
        ...
        >
          <h5 className="text-md text-forest-300 md:text-lg lg:text-xl">
          ...
          <ul className="grid grid-cols-2 gap-x-10 gap-y-1.5 overflow-hidden">
            {skills.map((skill, i) => {
              return (
                <li key={i} className="text-forest-700 text-md">
